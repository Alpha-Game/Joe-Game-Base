...
public final class StateWrapperSettableWhiteList implements IState {
	private IState fParent;
	private final Set<IStateType<?>> fAllowedTypes;
	
	public StateWrapperSettableWhiteList(IState parent) {
		fParent = parent;
		fAllowedTypes = new HashSet<IStateType<?>>();
	}
	
	public StateWrapperSettableWhiteList(IState parent, Collection<IStateType<?>> allowedTypes) {
		this(parent);
